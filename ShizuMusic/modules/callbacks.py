...
_HELP_TEXTS = {
    ...
    "rows": [
        ("/play &lt;song name or URL&gt;", "ᴘʟᴀʏ ᴀɴ ᴀᴜᴅɪᴏ ᴛʀᴀᴄᴋ ғʀᴏᴍ ᴀ sᴏɴɢ ɴᴀᴍᴇ ᴏʀ ᴜʀʟ"),
        ("/vplay &lt;song name or URL&gt;", "ᴘʟᴀʏ ᴀ ᴠɪᴅᴇᴏ ᴛʀᴀᴄᴋ ғʀᴏᴍ ᴀ sᴏɴɢ ɴᴀᴍᴇ ᴏʀ ᴜʀʟ"),
        ("ʀᴇᴘʟʏ ᴛᴏ ᴀᴜᴅɪᴏ/ᴠɪᴅᴇᴏ + /play", "ᴘʟᴀʏ ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴍᴇᴅɪᴀ ᴅɪʀᴇᴄᴛʟʏ"),
